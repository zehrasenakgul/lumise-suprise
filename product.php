...
$productImages = $lumise->lib->get_rows_without_author('product_images', $search_filter, $orderby, array(), $per_page, $start, array('product_id'=>$id), '');
                                ...
                                <div class="row">
                                    <figure class="product-main-image">
                                        <img id="product-zoom" src="<?php echo $thumbnail_url;?>"
                                            data-zoom-image="<?php echo $thumbnail_url;?>"
                                            alt="product image">
                                    ...
                                    <div id="product-zoom-gallery" class="product-image-gallery ">
                                        <?php foreach($productImages['rows'] as $image):?>
                                        <a class="product-gallery-item active" href="#"
                                            data-image="http://localhost/data/<?=$image['image']?>"
                                            data-zoom-image="http://localhost/data/<?=$image['image']?>">
                                            <img src="http://localhost/data/<?=$image['image']?>" alt="product side">
                                        </a>
                                        <?php endforeach;?>
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                <div class="product-details"
                                    style="border: 1px solid #21201f1a; padding: 32px; border-radius: 18px;width: 100%;">
                                        ...
                                        <div class="deliveryStatus__info">
                                            <div class="deliveryStatus__icon">
                                                <span class="uspIcons" style="display: flex;">
                                                    <svg style="fill: #5c815e;padding-top: 10px;width: 24px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z"/></svg>
                                    ...
                                    <br>
                                    <div class="col-lg-12"
                                        style="text-align: center; max-width: 100%; display: flex; justify-content: center;">
                                        <a href="<?php echo $lumise->cfg->tool_url.'?product_base='.$value['id']; ?>"
                                            class="newsletter-button button button--primary button--fluid js-newsletter-submit"
                                            type="submit"
                                            style="width: 100%; height: 100%;text-align: center; display: flex; justify-content: center; ">
                                ...
                                <div class=""
                                    style="border: 1px solid #21201f1a;width: 100%; padding: 32px; border-radius: 18px;">
                        ...
                        <div class="comments-area">
                            <div class="commentx">
                                ...
                                <div class="comment-content">
                                    das Geschenk wurde so geliefert, wie ich es bestellt habe, super
                                </div>
                            </div>
                            <div class="commentx">
                                <div class="comment-top">
