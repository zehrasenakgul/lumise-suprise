<?php
    ...
    $config = array(
		...
		'total_page'    => $items['total_page'],
 	    'limit'         => $per_page,
	    'link_full'     => $lumise->cfg->admin_url.'nevnes-page=orders&tpage={page}',
	    'link_first'    => $lumise->cfg->admin_url.'nevnes-page=orders',
	);
...
?><div class="lumise_wrapper">
	...
	<div class="lumise_content">
        ...
        <div class="lumise_option">
            <div class="left">
                <form action="<?php echo $lumise->cfg->admin_url;?>nevnes-page=orders" method="post">
        ...
        <div class="lumise_wrap_table">
			<table class="lumise_table lumise_orders">
				...
				<tbody>
	                ...
	                ?>
	                <tr>
						<td><a href="<?php echo $lumise->cfg->admin_url;?>nevnes-page=order&order_id=<?php echo $order['order_id'];?>"><?php printf($lumise->lang('Order #%s'), $order['order_id']);?></a></td>
						<td><?php 
