<?php
	...
	if (isset($_POST['do']) && !empty($_POST['do'])) {
		$lumise->redirect($lumise->cfg->admin_url . "nevnes-page=cliparts");
		exit;
	}
	...
	$config = array(
		...
		'total_page'    => ceil($total/$per_page),
 	    'limit'         => $per_page,
	    'link_full'     => $lumise->cfg->admin_url.'nevnes-page=cliparts&tpage={page}',
	    'link_first'    => $lumise->cfg->admin_url.'nevnes-page=cliparts',
	);
...
<div class="lumise_wrapper">
	...
	<div class="lumise_content">
		...
		<div class="lumise_header">
			...
			<a href="<?php echo $lumise->cfg->admin_url;?>nevnes-page=clipart" class="add-new lumise-button">
				<i class="fa fa-plus"></i>
				<?php echo $lumise->lang('Add new clipart'); ?>
			</a>
			<?php if ($can_upload) { ?>
			<a href="<?php echo $lumise->cfg->admin_url;?>nevnes-page=clipart" class="add-new lumise-button" id="lumise-add-bundle-cliparts">
				<i class="fa fa-th"></i>
		...
		<div class="lumise_option">
			<div class="left">
				<form action="<?php echo $lumise->cfg->admin_url;?>nevnes-page=cliparts" method="post">
				...
				<form action="<?php echo $lumise->cfg->admin_url;?>nevnes-page=cliparts" method="post" class="less">
						...
						foreach ($arts as $art) { ?>
							...
							<tr>
								...
								<td class="lumise-resource-title">
									<a href="<?php echo $lumise->cfg->admin_url;?>nevnes-page=clipart&id=<?php if(isset($art['id'])) echo $art['id'] ?>" class="name"><?php if(isset($art['name'])) echo $art['name']; ?></a>
		...
		<?php } else {
					if (isset($total_record[0]['total']) && $total_record[0]['total'] > 0) {
						...
						$_SESSION[$prefix.'data_search'] = '';
						echo '<a href="'.$lumise->cfg->admin_url.'nevnes-page=cliparts" class="btn-back"><i class="fa fa-reply" aria-hidden="true"></i>'.$lumise->lang('Back To Lists').'</a>';
					}
		...
		<div class="lumise-langs-wrp lumise_content">
			<div class="lumise_form_group">
				...
				<div class="lumise_form_content">
					...
					<a href="<?php echo $lumise->cfg->admin_url;?>nevnes-page=categories&type=cliparts" target=_blank class="add_cate" data-click="toggle-form">
						<i class="fa fa-plus"></i>
