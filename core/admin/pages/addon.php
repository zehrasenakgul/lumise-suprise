	...
	<div class="lumise_wrapper">
		<div class="lumise_content">
			<div class="lumise_header">
				<h2>
					<a href="<?php echo $lumise->cfg->admin_url?>nevnes-page=addons" title="<?php echo $lumise->lang('Back to Addons'); ?>">
...
<div class="lumise_wrapper" id="lumise-<?php echo $section; ?>-page">
	<div class="lumise_content">
		...
		<form action="<?php echo $lumise->cfg->admin_url; ?>nevnes-page=addon&name=<?php echo $name; ?>" id="lumise-clipart-form" method="post" class="lumise_form" enctype="multipart/form-data">
			...
			<div class="lumise_form_group lumise_form_submit">
				...
				<input type="hidden" name="lumise-redirect" value="<?php echo $lumise->cfg->admin_url; ?>nevnes-page=addon&name=<?php echo $name; ?>">
			</div>
		</form>
		<?php
			if (method_exists($lumise->addons->storage->{$name}, 'help'))
