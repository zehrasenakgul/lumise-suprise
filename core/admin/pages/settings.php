	...
	'tabs' => array(
		...
		'languages:' . $lumise->lang('Languages') => array(
			...
			array(
				...
				'desc' => '<a href="' . $lumise->cfg->admin_url . 'nevnes-page=languages"><i class="fa fa-plus"></i> ' . $lumise->lang('Add new language ') . '</a>'
			),
		),
		...
		'dashboard:' . $lumise->lang('Dashboard Settings') => array(
			array(
				'type' => 'input',
				'name' => 'banner_1_left_title',
				'label' => $lumise->lang('1. Alan Sol Banner Başlık'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_1_left_subtitle',
				'label' => $lumise->lang('1. Alan Sol Banner Altbaşlık'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_1_left_button_title',
				'label' => $lumise->lang('1. Alan Sol Banner Buton Yazısı'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_1_left_button_link',
				'label' => $lumise->lang('1. Alan Sol Banner Buton Linki'),
			),
			array(
				'type' => 'upload',
				'path' => 'banners' . DS,
				'name' => 'banner_1_right_button_image',
				'label' => $lumise->lang('1. Alan Sağ Banner Resmi'),
			),
			array(
				'type' => 'input',
				'name' => 'dashboard_2_title',
				'label' => $lumise->lang('2. Alan Başlık'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_3_left_title',
				'label' => $lumise->lang('3. Alan Sol Banner Başlık'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_3_left_subtitle',
				'label' => $lumise->lang('3. Alan Sol Banner Altbaşlık'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_3_left_input_text',
				'label' => $lumise->lang('3. Alan Sol Banner İnput Yazısı'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_3_left_button_title',
				'label' => $lumise->lang('3. Alan Sol Banner Buton Yazısı'),
			),
			array(
				'type' => 'upload',
				'label' => $lumise->lang('Upload favicon'),
				'path' => 'banners' . DS,
				'name' => 'banner_3_right_button_image',
				'label' => $lumise->lang('3. Alan Sağ Banner Resmi'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_4_title',
				'label' => $lumise->lang('4. Alan Başlık'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_4_title',
			...
			array(
				'type' => 'input',
				'name' => 'banner_4_subtitle',
				'label' => $lumise->lang('4. Alan Altbaşlık'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_4_left_subtitle',
				'label' => $lumise->lang('4. Alan Sol Alan Altbaşlık'),
			),
			array(
				'type' => 'input',
				'name' => 'banner_4_left_title',
				'label' => $lumise->lang('4. Alan Sol Alan Başlık'),
			),
			array(
				'type' => 'upload',
				'name' => 'banner_4_right_image',
				'path' => 'banners' . DS,
				'label' => $lumise->lang('4. Alan Sağ Alan Resim'),
			),
		),
		'footer:' . $lumise->lang('Footer Settings') => array(
			array(
				'type' => 'upload',
				'path' => 'footer' . DS,
				'name' => 'footer_logo',
				'label' => $lumise->lang("Footer Logo"),
			),
			array(
				'type' => 'input',
				'name' => 'footer_logo_link',
				'label' => $lumise->lang('Footer Logo url'),
				'desc' => $lumise->lang('The link will be redirect when click on the logo'),
			),
			array(
				'type' => 'text',
...
<div class="lumise_wrapper" id="lumise-<?php echo $section; ?>-page">
	<div class="lumise_content">
		<form action="<?php echo $lumise->cfg->admin_url; ?>nevnes-page=<?php
