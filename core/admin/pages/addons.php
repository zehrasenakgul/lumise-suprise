...
<div class="lumise_wrapper" id="lumise-addons-page">
	<div class="lumise_content">
		<div class="lumise_header">
			...
			<a href="<?php echo $lumise->cfg->admin_url; ?>nevnes-page=explore-addons" class="add_new active">
				<i class="fa fa-th"></i>
		...
		<div class="lumise_option">
			<div class="left">
				<form action="<?php echo $lumise->cfg->admin_url; ?>nevnes-page=addons" method="post">
		...
		<div id="license_noticesModal" class="modal">
		  <div class="modal-content">
		    ...
		    <div class="modal-footer">
			    <a id="link-addon-bundle" href="<?php echo admin_url('?page=lumise&nevnes-page=license'); ?>#lumise-tab-addon-bundle" class="link-to-license">Enter your license now</a>
			    <a id="link-addon-printful" href="<?php echo admin_url('?page=lumise&nevnes-page=license'); ?>#lumise-tab-addon-printful" class="link-to-license">Enter your license now</a>
			    <a id="link-addon-vendor" href="<?php echo admin_url('?page=lumise&nevnes-page=license'); ?>#lumise-tab-addon-vendor" class="link-to-license">Enter your license now</a>
			</div>
		  </div>
		</div>
						...
						if (count($items) > 0) {
							...
							foreach ($items as $item) {
								...
								if (isset($actives[$item['Slug']])) {
									echo '<strong>'.$item['Name'].'</strong><br><a href="'.$lumise->cfg->admin_url.'nevnes-page=addon&name='.$item['Slug'].'">Addon settings</a>';
								} else {
									echo $item['Name'];
								}
								echo '</td>';
