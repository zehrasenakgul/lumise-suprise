		...
		'tabs' => array(
			...
			'details:' . $lumise->lang('Details') => array(
				...
				array(
					...
					'desc' => $lumise->lang('Select Printing Techniques with price calculations for this product').'<br>'.$lumise->lang('Drag to arrange items, the first one will be set as default').'. <br><a href="'.$lumise->cfg->admin_url.'nevnes-page=printings" target=_blank>'.$lumise->lang('You can manage all Printings here').'.</a>'
				),
				array(
					'type' => 'toggle',
					'name' => 'active',
