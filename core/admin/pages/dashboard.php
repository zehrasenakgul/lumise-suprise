					...
					<table class="lumise_table">
						...
						<tbody>
							...
							if(count($orders['rows']) > 0){
								...
								?>
								<tr>
									<td><a href="<?php echo $lumise->cfg->admin_url;?>nevnes-page=order&order_id=<?php echo $item['id'];?>">#<?php echo $item['id'];?></a></td>
									...
									<td><a href="<?php echo $lumise->cfg->admin_url;?>nevnes-page=order&order_id=<?php echo $item['id'];?>">View</a></td>
								</tr>
								<?php
								}
							}else{
