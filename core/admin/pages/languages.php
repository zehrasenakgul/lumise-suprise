<?php
	...
	if (isset($_POST['per_page'])) {
		...
		$lumise->redirect($lumise->cfg->admin_url . "nevnes-page=languages");
    ...
    $config = array(
		...
		'total_page'    => $languages['total_page'],
 	    'limit'         => $per_page,
	    'link_full'     => $lumise->cfg->admin_url.'nevnes-page=languages&tpage={page}',
	    'link_first'    => $lumise->cfg->admin_url.'nevnes-page=languages',
	);
	...
	<div class="lumise_content">
		...
		<div class="lumise_option">
				<div class="left">
					...
					<form action="<?php echo $lumise->cfg->admin_url;?>nevnes-page=languages" method="post">
		...
		<?php } else {
					if (isset($total_record) && $total_record > 0) {
						...
						$_SESSION[$prefix.'data_search'] = '';
						echo '<a href="'.$lumise->cfg->admin_url.'nevnes-page=languages" class="btn-back"><i class="fa fa-reply" aria-hidden="true"></i>'.$lumise->lang('Back To Lists').'</a>';
					}
					else
