<?php
    ...
    $config = array(
		...
		'total_page'    => ceil($total/$per_page),
 	    'limit'         => $per_page,
	    'link_full'     => $lumise->cfg->admin_url.'nevnes-page=templates&tpage={page}',
	    'link_first'    => $lumise->cfg->admin_url.'nevnes-page=templates',
	);
...
<div class="lumise_wrapper">
	...
	<div class="lumise_content">
		...
		<div class="lumise_header">
			...
			<a href="<?php echo $lumise->cfg->admin_url;?>nevnes-page=template" class="add-new lumise-button">
			...
			<div class="lumise_option">
				<div class="left">
					<form action="<?php echo $lumise->cfg->admin_url;?>nevnes-page=templates" method="post">
					...
					<form action="<?php echo $lumise->cfg->admin_url;?>nevnes-page=templates" method="post" class="less">
								...
								foreach ($templates as $value) { ?>
									...
									<tr>
										...
										<td class="lumise-resource-title">
											<a href="<?php echo $lumise->cfg->admin_url;?>nevnes-page=template&id=<?php if(isset($value['id'])) echo $value['id']; ?>" class="name"><?php if(isset($value['name'])) echo $value['name']; ?></a>
		...
		<?php } else {
					if (isset($total_record[0]['total']) && $total_record[0]['total'] > 0) {
						...
						$_SESSION[$prefix.'data_search'] = '';
						echo '<a href="'.$lumise->cfg->admin_url.'nevnes-page=templates" class="btn-back"><i class="fa fa-reply" aria-hidden="true"></i>'.$lumise->lang('Back To Lists').'</a>';
					}
