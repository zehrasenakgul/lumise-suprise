<?php
    ...
    if(
        ...
        $lumise->redirect($lumise->cfg->admin_url.'nevnes-page=order&order_id='.$order_id);
    }
...
?><div class="lumise_wrapper">
	...
	<div class="lumise_content">
		...
		<div class="lumise_header">
			<h2>
				<a href="<?php echo $lumise->cfg->admin_url; ?>nevnes-page=orders"><?php echo $lumise->lang('All Orders'); ?></a> 
            ...
            <div class="lumise-order-details lumise_option">
                <div class="col-3">
                    ...
                    <div class="order_status">
                        ...
                        <form action="<?php echo $lumise->cfg->admin_url;?>nevnes-page=order&order_id=<?php echo $order_id;?>" method="post">
...
<b><a target="_blank" href="'.$lumise->cfg->admin_url.'nevnes-page=license"style="font-weight: 700; text-decoration: underline; font-style: italic;">Enter purchase code now</a></b></br>
<span>Notice: Each License can only be used for one domain.</br><a href="https://codecanyon.net/licenses/standard" target="blank" style="font-weight: 700; text-decoration: underline; font-style: italic;">Click to learn more about license term in Envato.</a></span>').'</font></p>';
									...
									if($key_valid) {
										$html .= '<a href="'.$url.'" target=_blank class="lumise-button">'.$lumise->lang('View in Nevnes editor').'</a>';
									}
