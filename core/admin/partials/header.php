...
<html lang="en">
	<head>
		...
		<title><?php echo (isset($title) ? $title : 'Nevnes Kontrol Panel'); ?></title>
		...
		<link rel="stylesheet" href="<?php echo $lumise->cfg->upload_url; ?>js/bootstrap-iconpicker/css/bootstrap-iconpicker.min.css">
		<?php
}
...
?>
	...
	<div class="lumise_sidebar">
		...
		?>
		<ver><span><a href="https://www.nevnes.com" target=_blank>Nevnes</span></a></ver>
	</div>
