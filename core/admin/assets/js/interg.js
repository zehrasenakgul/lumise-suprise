		...
		render_products = function(res) {
			...
			trigger({
				...
				new_product: function(e) {
					...
					$('#lumise-lightbox-content').addClass('full-screen').html('<iframe src="'+lumisejs.admin_url+'&nevnes-page=product&callback=edit-cms-product"></iframe>');
			...
			if (Object.keys(stages).length > 0) {
								...
								<div class="lumise-stage-settings lumise-product-design" id="lumise-product-design-'+s+'">\
									<div class="lumise-stage-body">\
										<div class="lumise-stage-design-view">\
											...
											<div class="lumise-stage-editzone" style="margin-left: '+stage.edit_zone.left+'px;margin-top: '+stage.edit_zone.top+'px;width: '+stage.edit_zone.width+'px;height: '+stage.edit_zone.height+'px;border-color: '+invert(color)+';border-radius:'+stage.edit_zone.radius+'%">\
				...
				if (lumisejs.inline_edit === true) {
					btn = '<span data-view="product-name">\
							<a title="'+data.name+'" href="'+lumisejs.admin_url+'&nevnes-page=product&id='+data.id+'&callback=edit-base-product" data-func="edit-base-product" class="lumise-button" title="'+lumisejs._i61+'">\
